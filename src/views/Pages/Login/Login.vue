...
import { data } from '../../../../../../materials/front-end/18-Vue/Vue笔记/Day 01/Vue源码/vue-2.5.21/test/weex/cases/event/click.vue'
export default {
	data() {
		return {
			// tab栏切换
	...
	methods: {
		...
		getCookie() {
			...
			this.account = str[0].split('=')[1]
			this.tab = this.account[0] === 't' ? 1 : 0
			this.password = str[1].split('=')[1]
			this.checked = true
		},
		validate() {
			// 输入不合法
